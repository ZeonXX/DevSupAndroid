...
package com.sup.dev.android.views.widgets.cropper;
...
public class CropOverlayView extends View {
  ...
  private ViewCropImage.Guidelines mGuidelines;
  private ViewCropImage.CropShape mCropShape;
  ...
  public ViewCropImage.CropShape getCropShape() {
    return mCropShape;
  }

  public void setCropShape(ViewCropImage.CropShape cropShape) {
    if (mCropShape != cropShape) {
      mCropShape = cropShape;
        if (Build.VERSION.SDK_INT <= 17) {
        if (mCropShape == ViewCropImage.CropShape.OVAL) {
  ...
  public ViewCropImage.Guidelines getGuidelines() {
    return mGuidelines;
  }

  public void setGuidelines(ViewCropImage.Guidelines guidelines) {
  ...
  protected void onDraw(Canvas canvas) {
    ...
    if (mCropWindowHandler.showGuidelines()) {
      ...
      if (mGuidelines == ViewCropImage.Guidelines.ON) {
        drawGuidelines(canvas);
      } else if (mGuidelines == ViewCropImage.Guidelines.ON_TOUCH && mMoveHandler != null) {
  ...
  private void drawBackground(Canvas canvas) {
    ...
    if (mCropShape == ViewCropImage.CropShape.RECTANGLE) {
      ...
      mPath.reset();
        if (Build.VERSION.SDK_INT <= 17 && mCropShape == ViewCropImage.CropShape.OVAL) {
  ...
  private void drawCorners(Canvas canvas) {
    if (mBorderCornerPaint != null) {
      ...
      float w =
          cornerWidth / 2
              + (mCropShape == ViewCropImage.CropShape.RECTANGLE ? mBorderCornerOffset : 0);
