...
class ViewParticles @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) : View(context, attrs) {
    ...
    var createYMin = -1f
    var createYMax = -1f
    var timeToCreateMin: Long = 10
    var timeToCreateMax: Long = 60
    var timeToLifeMin: Long = 2000
    var timeToLifeMax: Long = 8000
    var speedXMin = (-ToolsView.dpToPx(12)).toFloat()
    var speedXMax = ToolsView.dpToPx(12).toFloat()
    var speedYMin = (-ToolsView.dpToPx(12)).toFloat()
    var speedYMax = ToolsView.dpToPx(12).toFloat()
    var speedChangeXMin = (-ToolsView.dpToPx(1)).toFloat()
    var speedChangeXMax = ToolsView.dpToPx(1).toFloat()
    var speedChangeYMin = (-ToolsView.dpToPx(1)).toFloat()
    var speedChangeYMax = ToolsView.dpToPx(1).toFloat()
    var rotationMin = 0f
    var rotationMax = 360f
    var rotationChangeMin = 10f
    var rotationChangeMax = 40f
    var alphaMin = 1f
    var alphaMax = 1f
    var alphaChangeMin = -0.2f
    var alphaChangeMax = -0.05f
    ...
    private inner class Particle {
        ...
        fun onDraw(canvas: Canvas) {
            ...
            paint.color = ToolsColor.setAlpha(Math.max(255, Math.min(0, (255 * alpha).toInt())), color)
