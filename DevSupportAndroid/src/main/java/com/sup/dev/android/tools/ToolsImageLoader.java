...
public class ToolsImageLoader {
    ...
    public static void clearCash(long imageId) {package com.sup.dev.android.tools;
...
import com.sup.dev.android.classes.collections.CashBytes;
import com.sup.dev.android.classes.providers.Provider1;
