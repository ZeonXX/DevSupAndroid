...
class ViewAvatarTitle constructor(context: Context, attrs: AttributeSet? = null) : LayoutCorned(context, attrs) {
    ...
    init {
        ...
        val iconSizePadding = a.getDimension(R.styleable.ViewAvatarTitle_ViewAvatarTitle_chipIconSizePadding, 0f)
        ...
        viewAvatar.setChipIconSizePadding(iconSizePadding)
