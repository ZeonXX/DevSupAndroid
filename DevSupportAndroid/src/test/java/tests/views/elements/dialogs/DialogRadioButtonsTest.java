...
import com.sup.dev.android.views.elements.dialogs.DialogRadioButtons;
...
public class DialogRadioButtonsTest {

    private DialogRadioButtons dialog;
    ...
    public void before() {
        TestAndroid.init();
        dialog = new DialogRadioButtons(RuntimeEnvironment.application);
    ...
    public void addItem() {
        ...
        assertEquals("test", ((RadioButton)vOptionsContainer.getChildAt(0)).getText().toString());
        assertEquals("test 1", ((RadioButton)vOptionsContainer.getChildAt(1)).getText().toString());
    ...
    public void setSelectedKey() {
        ...
        assertTrue(((RadioButton)vOptionsContainer.getChildAt(1)).isChecked());
    }
